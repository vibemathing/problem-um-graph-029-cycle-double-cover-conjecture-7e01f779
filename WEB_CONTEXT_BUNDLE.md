...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-029-cycle-double-cover-conjecture-7e01f779-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-029"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-029-cycle-double-cover-conjecture-7e01f779-v1",
      "problem_contract_sha256": "20a38feb708ab4a755758d08acb6bea0eae944cfc568decbc5098575b780dec7",
      "problem_id": "problem:um-graph-029-cycle-double-cover-conjecture-7e01f779",
      "route_id": "route:um-graph-029-cycle-double-cover-conjecture-7e01f779-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-029-cycle-double-cover-conjecture-7e01f779-source-fidelity-01",
      "graph_id": "graph:um-graph-029-cycle-double-cover-conjecture-7e01f779-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-029-cycle-double-cover-conjecture-7e01f779-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-029-cycle-double-cover-conjecture-7e01f779-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every bridgeless graph have a collection of cycles that covers each edge exactly twice?"
          },
          "statement_sha256": "d25cd4ba6c1ff732c6395d12174dbf2576d8370c6c31a30b756e1e8a1475514a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-029-cycle-double-cover-conjecture-7e01f779-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-029-cycle-double-cover-conjecture-7e01f779-root",
      "route_id": "route:um-graph-029-cycle-double-cover-conjecture-7e01f779-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-029-b9d9af878083",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-029"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
